...
{{-- we they --}}
  ...
  <p class="kh22-b" style="text-align:center;color:red;padding:0px;">បញ្ជីដៃគូ {{ $partnername }}</p>

  <table id="tbl_we" class="table table-bordered kh16" style="margin:0px;width:100%;">
      <thead style="text-align:center;">
          ...
          <th style="width:180px;">សរុបទឹកប្រាក់</th>
          <th style="width:180px;">សមតុល្យ</th>
          <th style="width:150px;">Sender</th>
          <th style="width:200px;">Receiver</th>
          <th style="width:200px;">ផ្សេងៗ</th>
          <th style="width:220px;">ចំនួនទឹកប្រាក់​</th>
      ...
      <tbody id="bodytransfer">
        ...
        @if($oldlist)
          @foreach ($oldlist->where('cur','USD') as $l)
              ...
              <tr class="tr_usd" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                  ...
                  <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($l->total) .  '$'  }}</td>
                  <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) .  '$'  }}</td>
                  <td>{{ $l->sender??'' }}</td>
                  <td>
                    @if($l->desr)
                      {{ $l->desr }}
                  ...
                  <td style="text-align:right;" class="kh16-b">{{ phpformatnumber($l->fee) . $l->cur}}</td>
              </tr>
          @endforeach
        @endif
        @foreach ($records->where('cur','USD') as $l)
            ...
            <tr class="tr_usd" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                ...
                <td>{{ $l->tranname??'' }}</td>
                <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ $l->total>0?'+':'' }}{{ phpformatnumber($l->total) . '$' }}</td>
                <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) . '$' }}</td>
            ...
            @if($l->ref_group_id  && ($l->trancode==1 || $l->trancode==-1) && (is_null($l->pointname) || $l->pointname==''))
              ...
              @endphp
              <tr id="c{{ $l->id }}" class="tr_usd collapse" style="">
        ...
        <tr class="tr_usd" style="border:2px solid black;border-top:1px;">
            <td colspan=7 style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh18-b">{{ phpformatnumber($total).'USD'}}</td>
        ...
        @if($oldlist)
          @foreach ($oldlist->where('cur','THB') as $l)
              ...
              <tr class="tr_thb" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                  ...
                  <td></td>
                  <td>{{ $l->tranname??'លុយសល់' }}</td>
                  <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($l->total) .  'B'  }}</td>
                  <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) .  'B'  }}</td>
                  <td>{{ $l->sender??'' }}</td>
                  <td>
                    @if($l->desr)
                      {{ $l->desr }}
        ...
        @foreach ($records->where('cur','THB') as $l)
            ...
            <tr class="tr_thb" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                ...
                <td>{{ $l->tranname??'' }}</td>
                <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ $l->total>0?'+':'' }}{{ phpformatnumber($l->total) . 'B' }}</td>
                <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) . 'B' }}</td>
            ...
            @if($l->ref_group_id  && ($l->trancode==1 || $l->trancode==-1) && (is_null($l->pointname) || $l->pointname==''))
              @php
                  $getdata=App\PartnerTransfer::showbyrefgroupid($l->idtransfer,$l->ref_group_id);
              @endphp
              <tr id="c{{ $l->id }}" class="tr_thb collapse" style="">
                  <td style="padding:0px;" colspan=13>
                      <table id="tbl_group_id" class="table table-bordered" style="margin:0px;width:50%">
                          <tbody>
                            @foreach ($getdata[0] as $ex)
        ...
        <tr class="tr_thb" style="border:2px solid black;border-top:1px;">
            <td colspan=7 style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh18-b">{{ phpformatnumber($total).'THB'}}</td>
        ...
        @if($oldlist)
          @foreach ($oldlist->where('cur','KHR') as $l)
              ...
              <tr class="tr_khr" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                  ...
                  <td></td>
                  <td>{{ $l->tranname??'លុយសល់' }}</td>
                  <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($l->total) .  'R'  }}</td>
                  <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) .  'R'  }}</td>
                  <td>{{ $l->sender??'' }}</td>
                  <td>
                    @if($l->desr)
                      {{ $l->desr }}
        ...
        @foreach ($records->where('cur','KHR') as $l)
            ...
            <tr class="tr_khr" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                ...
                <td>{{ $l->tranname??'' }}</td>
                <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ $l->total>0?'+':'' }}{{ phpformatnumber($l->total) . 'R' }}</td>
                <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) . 'R' }}</td>
            ...
            @if($l->ref_group_id  && ($l->trancode==1 || $l->trancode==-1) && (is_null($l->pointname) || $l->pointname==''))
              @php
                  $getdata=App\PartnerTransfer::showbyrefgroupid($l->idtransfer,$l->ref_group_id);
              @endphp
              <tr id="c{{ $l->id }}" class="tr_khr collapse" style="">
                  <td style="padding:0px;" colspan=13>
                      <table id="tbl_group_id" class="table table-bordered" style="margin:0px;width:50%">
                          <tbody>
                            @foreach ($getdata[0] as $ex)
      ...
      <tr class="tr_khr" style="border:2px solid black;border-top:1px;">
          <td colspan=7 style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh18-b">{{ phpformatnumber($total).'KHR'}}</td>
        ...
        @if($oldlist)
          @foreach ($oldlist->where('cur','VND') as $l)
              ...
              <tr class="tr_vnd" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                  ...
                  <td></td>
                  <td>{{ $l->tranname??'លុយសល់' }}</td>
                  <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($l->total) .  'V'  }}</td>
                  <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) .  'V'  }}</td>
                  <td>{{ $l->sender??'' }}</td>
                  <td>
                    @if($l->desr)
                      {{ $l->desr }}
        ...
        @foreach ($records->where('cur','VND') as $l)
            ...
            <tr class="tr_vnd" style="border:1px solid black;border-left:2px solid black;border-right:2px solid black;">
                ...
                <td>{{ $l->tranname??'' }}</td>
                <td style="text-align:right;@if($l->total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ $l->total>0?'+':'' }}{{ phpformatnumber($l->total) . 'V' }}</td>
                <td style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh16-b">{{ phpformatnumber($total) . 'V' }}</td>
            ...
            @if($l->ref_group_id  && ($l->trancode==1 || $l->trancode==-1) && (is_null($l->pointname) || $l->pointname==''))
              @php
                  $getdata=App\PartnerTransfer::showbyrefgroupid($l->idtransfer,$l->ref_group_id);
              @endphp
              <tr id="c{{ $l->id }}" class="tr_vnd collapse" style="">
                  <td style="padding:0px;" colspan=13>
                      <table id="tbl_group_id" class="table table-bordered" style="margin:0px;width:50%">
                          <tbody>
                            @foreach ($getdata[0] as $ex)
        ...
        <tr class="tr_vnd" style="border:2px solid black;border-top:1px;">
            <td colspan=7 style="text-align:right;@if($total>0)color:blue;@else color:red; @endif" class="kh18-b">{{ phpformatnumber($total).'VND'}}</td>
