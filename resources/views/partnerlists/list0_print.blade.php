    ...
    <div id="invoice-pos">
        <div class="" style="margin-top:20px;">
            <div class="row" style="margin:0px 5px 10px 5px;">
                <table>
                    <tr>
                        <td class="kh16-b">សៀវភៅបញ្ជី ដៃគូ {{ $partnername }}</td>
                        @if($alldate=='true')
                      ...
                      <table id="tbl" class="table table-bordered kh16">
                          ...
                          <tbody id="bodytransfer">
                              ...
                              @if($selcur=='usd' || $selcur=='all currency')
                                ...
                                @endforeach
                                <tr style="">
                                    <td colspan=6 class="kh14-b" style="text-align:right;">{{ phpformatnumber(abs($amount)) . '$'}}</td>
                              ...
                              @endphp
                                @if($selcur=='thb' || $selcur=='all currency')
                                    ...
                                    @endforeach
                                    <tr style="">
                                        <td colspan=6 class="kh14-b" style="text-align:right;">{{ phpformatnumber(abs($amount)) . 'B'}}</td>
                            ...
                            @if($selcur=='khr' || $selcur=='all currency')
                              ...
                              @endforeach
                              <tr style="">
                                  <td colspan=6 class="kh14-b" style="text-align:right;">{{ phpformatnumber(abs($amount)) . 'R'}}</td>
                            ...
                            @endif
                              ...
                              @if($selcur=='vnd' || $selcur=='all currency')
                                ...
                                @endforeach
                                <tr style="">
                                    <td colspan=6 class="kh14-b" style="text-align:right;">{{ phpformatnumber(abs($amount)) . 'V'}}</td>
