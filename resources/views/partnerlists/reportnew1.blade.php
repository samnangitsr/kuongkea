...
<div class="tableFixHead" style="padding:0px;">
    ...
    <table id="tbl_partner_list" class="table table-bordered table-hover" style="table-layout:fixed;">
        <thead style="text-align:center;" class="kh14">
            ...
            <th style="padding:0px;width:150px;">ប្រតិបត្តិការណ៏</th>
            ...
            @endif
            <th style="padding:0px;width:200px;">អ្នកទទួល</th>
            <th style="padding:0px;width:200px;">អ្នកផ្ញើ</th>
            <th style="padding:0px;width:150px;">អ្នកកត់ត្រា</th>
        ...
        <tbody id="bodytransfer">
            @foreach ($ptls_new as $key =>$l)
                ...
                <tr style="">
                    ...
                    <td class="kh14" style="padding:0px;">{{ $l->tranname }}</td>
                    ...
                    @endif
                    <td class="kh14" style="padding:0px;">{{ $l->rectel }}</td>
                    <td class="kh14" style="padding:0px;">{{ $l->sendertel }}</td>
            ...
            <tr style="background-color:aqua">
                <td colspan=5 class="kh16-b" style="color:black;padding:2px 5px 2px 20px;">សរុប</td>
