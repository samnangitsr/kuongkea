...
<style>
    ...
    .service{
       ...
       #tbl_exchange tbody tr.last-ex {
        ...
        #tbl_deposit_detail td{
            padding:0px 3px;
            border:1px solid black;
        }
        #tbl_deposit_detail th{
            text-align:center;
            padding:0px;
            border:1px solid black;
        }
    ...
    <div id="invoice-pos">
        ...
        <div class="row" style="margin:-10px 5px 0px 5px;">
            ...
            <div class="row" style="padding:0px;margin:0px;margin-top:-10px;">
                <table id="tbl_deposit_detail" class="table kh16-b">
                    <thead>
                        <th style="">ថ្ងៃទូទាត់</th>
                        <th style="">ទឹកប្រាក់</th>
                        <th>ទូទាត់តាម</th>
                    ...
                    <tbody>
                        @foreach ($deposit_details as $item)
                            <tr>
                                ...
                                <td style="text-align:right;">{{ phpformatnumber(-1 * $item->amount)}}$</td>
                                <td>{{ $item->deposit_via }}</td>
