...
@php
    ...
    function changeshortcut($shortcut){
        if($shortcut=='KHR'){
            return 'R';
        }else if($shortcut=='USD'){
            return '$';
        }else if($shortcut=='THB'){
            return 'B';
        }else if($shortcut=='VND'){
            return 'V';
        }else{
            return $shortcut;
        }
                    ...
                    <tbody>
                        ...
                        <tr class="" style="">
                            ...
                            <td class="exchange1" style="text-align:right;">
                                +{{ phpformatnumber($e->buy)  . changeshortcut($e->curbuy)  }}
                                @php
                            ...
                            <td class="exchange1" style="text-align:right;">
                                -{{ phpformatnumber($e->sale) . changeshortcut($e->cursale)}}
                                @php
