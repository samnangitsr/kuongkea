    ...
    <div id="invoice-pos">
        ...
        <div class="row">
            <div class="table-responsive">
                <table class="" style="width:100%;overflow:hidden">
                    <tr>
                        <td class="kh16" style="width:100%;text-align:center;padding:0px;text-decoration:underline;">{{ $reprint==0?'Exchange Receipt':'Exchange Reprint' }}</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="row" style="padding:0px;margin:0px;">
                <table id="tbl_exchange" class="table table-bordered" style="width:100%;">
                  <thead class="kh12" style="text-align:center;">
                    ...
                    @endif --}}
                    <th style="font-weight:100;" >Buy</th>

                    <th style="font-weight:100;">Rate</th>


                    <th style="font-weight:100;">Sale</th>
