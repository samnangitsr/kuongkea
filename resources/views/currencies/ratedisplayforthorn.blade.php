    ...
    <div class="row" id="displayrate" style="margin:20px;">
        <div class="col-lg-6 col-md-12 col-sm-12" style="">
            <div id="divcol1" class="row" style="margin-left:0px;">
                ...
                <table class="table" style="margin:0px;">
                    <tr style="background-color:rgb(121, 208, 230);">
                        <td style="width:25%;border-style:none;">
                            <img style="width:200px;" src="{{ asset('public/logo') . '/ksplogo.png'  }}" />
                        </td>
                ...
                <table class="table"  style="width:100%;background-color:rgb(125, 226, 240);">
                    ...
                    <tbody>
                        ...
                        <tr style="">
                            ...
                            <td class="bc12" style="color:black;">
                                <div class="mainshortcut">
                                    <div class="circular--landscapekhr" style=""> <img style="margin-left:-50px;" src="{{ asset('public/logo') . '/thb-khr1.png'}}" /> </div>
                        ...
                        <tr style="">
                            ...
                            <td class="bc12" style="color:black;">
                                <div class="mainshortcut">
                                    <div class="imgflag">
                                        <div class="circular--landscape"> <img style="margin-left:-20px;" src="{{ asset('public/logo') . '/usd-thb.png'}}" /> </div>
                                    </div>
                                    <div class="khshortcut">
                                        ដុល្លា-បាត
                                    </div>
                        ...
                        <tr style="">
                            ...
                            <td class="bc12" style="color:black;">
                                <div class="mainshortcut">
                                    <div class="circular--landscapekhr"> <img src="{{ asset('public/logo') . '/usd-khr.png'}}" /> </div>
                                    <div class="khshortcut">
                                        ដុល្លា-រៀល
                                    </div>
                                    <div class="enshortcut">
                ...
                <table class="table" style="margin-top:-10px;">
                    <tr style="background-color:skyblue;">
                        <td style="font-family:khmer os muol light; font-size:42px;padding-top:50px;border-style:none;">
                            ទំនាក់ទំនង៖
                            <span style="font-family:Arial, Helvetica, sans-serif;font-size:42px;font-weight:bold;">078 405555 / 085 277779</span> <br>
                            <span class="kh32">
                                ចំណាំ៖អត្រាប្តូរប្រាក់ខាងលើនិងមានការផ្លាស់ប្តូរដោយពុំចាំបាច់ផ្តល់ដំណឹងជូនមុន។
                            </span>
                        </td>
                        <td rowspan=2 style="text-align:right;border-style:none;">
                            <img style=" width:200px;" src="{{ asset('public/logo') . '/ksp_te_qr1.png'  }}" />
                        </td>
                    </tr>
                    <tr style="background-color:skyblue;">
            ...
            <div id="divcol1" class="row" style="margin-left:0px;">
                    ...
                    <table class="table" style="margin:0px;">
                        <tr style="background-color:#ffe699;">
                            <td style="width:25%;border-style:none;">
                                <img style="width:200px;" src="{{ asset('public/logo') . '/ksp.png'  }}" />
                            </td>
                            <td style="text-align:center;border-style:none;color:green;">
                                <div class="mainshortcut">
                    ...
                    <table class="table"  style="width:100%;background-color:rgb(228, 197, 20)">
                        <tbody>
