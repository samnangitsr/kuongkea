...
// }
           ...
           if(w==1920){
            ...
            if(w<=900){
                ...
                if(w<600){
                    ...
                    // var flagcounter=document.getElementsByClassName('flagcounter');
                    //  for(i=0; i<flagcounter.length; i++) {
                    //     flagcounter[i].style.display='none';
        ...
        function refreshpage(){
            var url="{{ route('currency.refreshdisplayrate') }}";
            $.get(url,{},function(data){
