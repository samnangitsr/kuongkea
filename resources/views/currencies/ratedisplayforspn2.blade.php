    ...
    <div class="row" id="displayrate" style="margin:20px;">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <div id="divcol1" class="row" style="margin-left:0px;">
                <div class="card" style="background-color:#030A36;">
                    <div class="card-body">
                        <table class="table" style="margin:0px;">
                            <tr style="background-color:#030A36;">
                                ...
                                <td style="text-align:center;border-style:none;color:green;">
                                    <div class="mainshortcut">
                                        ...
                                        <div class="" style="font-family:khmer os muol light;font-size:52px;font-weight:bold;color:white;">
                                            អត្រាប្តូរប្រាក់
                                        </div>
                                        <div class="" style="font-family:Arial, Helvetica, sans-serif;font-size:42px;font-weight:bold;margin-top:0px;color:white;">
                                            Exchange Rate
                                        </div>
                                    </div>
                                ...
                                <td style="width:25%;border-style:none;font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;text-align:right;">
                                    ...
                                    <div class="mainshortcut">
                                        <div class="" style="font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;margin-top:73px;color:white;">
                                            {{ date('d-m-Y',strtotime($updated_at))  }}
                                        </div>
                                        <div class="" style="font-family:Arial, Helvetica, sans-serif;font-size:36px;font-weight:bold;margin-top:-20px;color:white;">
                        ...
                        <table class="table table-bordered"  style="width:100%;background-color:whitesmoke;">
                            <tbody>
                                ...
                                @endforeach
                                <tr style="background-color:#030A36;border:1px solid #030A36;">
                                    <td style="font-family:khmer os muol light;font-size:52px;text-align:center;color:white;" colspan=3>អត្រាលុយបាតកុងថៃ</td>
                                </tr>
                        ...
                        <table class="table" style="margin-top:-10px;">
                            <tr style="background-color:#030A36;color:white;">
                            ...
                            <tr style="background-color:#030A36;">
                                <td style="border-style:none;margin-top:-25px;" class="kh22-b">
                                </td>
                            </tr>
                        </table>
                    </div>
