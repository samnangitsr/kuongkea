...
<head>
    ...
    <title>transfer report print</title>
...
<style>
    @page{size: A4 landscape;margin:10px 10px 0px 20px;}
    @media print {
        html, body {
...
<body>
    <div id="invoice-pos">
        ...
        <div class="row" style="margin:0px;">
            <table class="table">
                <tr>
                    <td class="kh16-b" style="border-style:none;">{{ $rpttitle . '(' . $partnername . ')'  }}</td>
        ...
        <div class="row" style="margin-top:-10px">
            <table id="tbl_partner_transfer" class="table table-bordered table-hover kh12" style="">
                <thead style="text-align:center;" class="">
                    <th style="width:70px;">N <sup>o</sup></th>
                    <th style="width:100px;">Date</th>
                    <th style="width:150px;">Transaction</th>
                    <th style="width:200px;">PartnerName</th>
                    <th style="width:150px;">Amount</th>
                    <th style="width:100px;">Charge</th>
                    <th style="width:100px;">Fee</th>
                    <th style="width:300px;">CustomerInfo</th>
                </thead>
                <tbody id="bodytransfer" class="kh12-b">
                    @foreach ($data as $key => $d)
                            <tr class="rowclick {{ $d->status==0?'delrecord':'' }}">
                                ...
                                <td>
                                    @php
                                        ...
                                        if($d->sendername){
                                            $info2='Send:' . $d->sendername;
                                        }
                                        if($d->sendertel){
                                            if($info2==''){
                                                $info2='Send' . $d->sendertel;
                                            }else{
