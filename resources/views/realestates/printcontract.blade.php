            ...
            <table id="tbl_a" class="table tbl_a">
                ...
                <tr>
                    <td colspan=3 style="text-align:center; font-family:khmer os muol light;font-size:15px;color:blue;padding-top:20px;">
                       {{ $ct->property->group->addrhead??'កិច្ចសន្យាកក់ប្រាក់ថ្លៃទិញដីល្វែង ភូមិផ្សារកណ្តាល សង្កាត់ផ្សារកណ្តាល ក្រុងប៉ោយប៉ែត ខេត្តបន្ទាយមានជ័យ' }}  <br> រវាង
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table id="tblcontra" class="table">
                ...
                <tr>
                    <td>
                        ...
                        <span>សញ្ជាតិ @if($ct->nation_b=='khr')ខ្មែរ @elseif($ct->nation_a=='thb')ថៃ @elseif($ct->nation_a=='vnd')វៀតណាម @endif </span>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <span class="brakacontent1">-ខាងជើងទល់នឹង</span>
                                    <span style="padding-left:10px;">{{ $ct->north }}</span>
                                </td>
                                <td>
                                    <span class="brakacontent2">-ខាងត្បូងទល់នឹង</span>
                                    <span style="padding-left:10px;">{{ $ct->south }}</span>
                                </td>

                            </tr>
                            <tr>
                                <td>
                                    <span class="brakacontent1">-ខាងកើតទល់នឹង</span>
                                    <span style="padding-left:10px;">{{ $ct->east }}</span>
                                </td>
                                <td>
                                    <span class="brakacontent2">-ខាងលិចទល់នឹង</span>
                                    <span style="padding-left:10px;">{{ $ct->west }}</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:20px 10px 0px 0px;text-align:right;">
