                ...
                <tbody>
                   ...
                   @foreach ($transfergroup as $key => $g)
                       ...
                       <tr>
                        ...
                        <td class="kh14-b" style="text-align:right;">{{ phpformatnumber($g->amount) . ' ' . $g->currency->shortcut }}</td>
                        <td class="kh14-b" style="text-align:right;">{{ phpformatnumber($g->cuscharge) . ' ' . $g->currency->shortcut }}</td>
                        <td class="kh14-b" style="text-align:right;">{{ phpformatnumber($g->amount+$g->cuscharge) . ' ' . $g->currency->shortcut }}</td>
