                ...
                <td style="width:25%">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width:10px;">:</td>
                            <td style="font-size:14px;font-weight:bold;">{{ $transfer->sendername }}</td>
                        </tr>
            ...
            <table id="tbldetail" class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="kh16-b" style="text-align:right;">{{ phpformatnumber($transfer->commission) . $transfer->currency->sk }}</td>
                        <td class="kh16-b" style="text-align:right;">{{ '-' . phpformatnumber(abs($transfer->deposited)-abs($transfer->amount)) . $transfer->currency->sk . '(' . $transfer->countdeposit-1 . ')'}}</td>
                        <td class="kh16-b" style="text-align:right;">{{ phpformatnumber($transfer->amount) . $transfer->currency->sk }}
                            <br>
                            @if($transfer->deposit_via_id=='ash')
                                {{ $transfer->deposit_via . '(' . phpformatnumber($transfer->cash_amount) . $transfer->currency->sk . ')'  }}
                            @else
                                {{ $transfer->deposit_via . '(' . phpformatnumber($transfer->bank_amount) . $transfer->currency->sk . ')'  }}
                            @endif
                        </td>
                        <td class="kh16-b" style="text-align:right;">{{ phpformatnumber(abs($transfer->commission)-abs($transfer->deposited)) . $transfer->currency->sk }}</td>
                    </tr>
                </tbody>
            </table>
            <div class="row">
