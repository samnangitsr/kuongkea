@extends('master')
@section('title') Partner List @endsection
@section('css')
    <style type="text/css">
        body.wait, body.wait *{
...
@section('content')
  ...
  <div class="row" style="margin-top:20px;">
    ...
    <p class="kh22-b" style="text-align:center;color:rgb(237, 19, 19);padding:0px;">បើកនៅ{{ $logo->name }}</p>
              ...
              @if($weopen_oldlist)
                @foreach ($weopen_oldlist->where('cur','USD') as $l)
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;" class="kh16">{{ $l->cur }}</td>
                        <td>{{ $l->sender??'' }}</td>
                        <td>
                          @if($l->desr)
                            {{ $l->desr }}
