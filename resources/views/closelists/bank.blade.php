@extends('master')
@section('title') closelist-Bank @endsection
@section('css')
            ...
            <div class="card-header">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="txtclosedate" name="txtclosedate" class="kh22" value="{{ date('d-m-Y',strtotime($viewdate)) }}" style="background-color:transparent;border-style:none;text-align:right;" readonly></td>
                    </tr>
                </table>
                            ...
                            <thead style="text-align:center;">
                                ...
                                <tbody id="tbl_closelist">
                                    ...
                                    <tr>
                                        ...
                                        <td>លុយយោង</td>
                                        <td style="text-align:right;">{{ phpformatnumber($usd1) }}</td>
                                        <td style="text-align:right;">{{ phpformatnumber($thb1) }}</td>
                                        <td style="text-align:right;">{{ phpformatnumber($khr1) }}</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                   @foreach ($newlists as $key => $item)
                                       ...
                                       <tr>
                                        ...
                                        <td class="kh16">{{ $item->tranname }}</td>
                                        <td class="kh16" style="text-align:right;">
                                            {{ phpformatnumber($usd2) }}
                                        </td>
                                        <td class="kh16" style="text-align:right;">
                                            {{ phpformatnumber($thb2) }}
                                        </td>
                                        <td class="kh16" style="text-align:right;">
                                            {{ phpformatnumber($khr2) }}
                                        </td>
