                        ...
                        <td style="text-align:right;">
                            <div class="dropdown" style="display:inline;">
                                ...
                                <ul class="dropdown-menu" style="padding:5px;background-color:azure;">
                                    ...
                                    <li class="" style="">
                                        <a href="#" class="dropdown-item btnopencashdraw kh16-b" data-classname="btnopencashdraw" data-id="{{ $d->id }}" data-code="{{ $d->smsid }}">បើកលុយ</a>
                                    </li>
                                    <li style="">
                                        <a href="#" class="dropdown-item btncontinuepartner kh16-b" data-classname="btncontinuepartner"  data-id="{{ $d->id }}" data-code="{{ $d->smsid }}">បន្តតាមដៃគូ</a>
                                    </li>
                                    <li style="">
                                        <a href="#" class="dropdown-item btncontinuewingbank kh16-b" data-classname="btncontinuewingbank" data-id="{{ $d->id }}" data-code="{{ $d->smsid }}">បន្តតាមវីងឬធនាគា</a>
                                    </li>
                                    <li style="">
                                        <a href="#" style="" class="dropdown-item btnclearselect kh16-b" data-classname="btnclearselect" data-id="{{ $d->id }}" data-code="{{ $d->smsid }}">Clear Select</a>
                                    </li>
                                    <li style="">
                                        <a href="#" style="" class="dropdown-item btnnote kh16-b" data-classname="btnnote" data-id="{{ $d->id }}" data-rowind="{{ $key }}" data-code="{{ $d->smsid }}">កំណត់សំគាល់</a>
                                    </li>
                                </ul>
                                </div>
